...
const virtualFileCommands_1 = require("./virtualFileCommands");
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        /**
         * Virtual file display command for debugging template interpolation
         */
        context.subscriptions.push(yield virtualFileCommands_1.registerVeturTextDocumentProviders());
        /**
...
function registerCustomClientNotificationHandlers(client) {
    ...
    client.onNotification('$/showVirtualFile', (virtualFileSource, prettySourceMap) => {
        virtualFileCommands_1.setVirtualContents(virtualFileSource, prettySourceMap);
    });
}
function registerCustomLSPCommands(context, client) {
    context.subscriptions.push(vscode.commands.registerCommand('vetur.showCorrespondingVirtualFile', virtualFileCommands_1.generateShowVirtualFileCommand(client)));
}
